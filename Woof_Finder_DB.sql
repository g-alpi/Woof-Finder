...
("Mishu", 1, "Hembra", "Pequeño", "mishu.jpg", NULL, "Mishu es una gatita muy juguetona y curiosa. Le encanta explorar su entorno y jugar con todo lo que encuentra. Es un compañera ideal para alguien que busque una gata activa y entretenida.", "En adopcion", NULL, 2, 14),
("Garfield", 5, "Macho", "Grande", "garfield.jpg", "Sobrepeso", "Garfield es un gato muy tranquilo y le gusta dormir. Es muy cariñoso y le gusta que le acaricien la barriga. Es un compañero ideal para alguien que busque un gato tranquilo y amoroso.", "En adopcion", 2, 2, 15),
("Simba", 0.5, "Hembra", "pequeño", "simba.jpg", "Sobrepeso", "Simba es una gata muy tranquila y le gusta dormir. Es muy curiosa y le gusta jugar con juguetes. Es un compañera ideal para alguien que busque una gata joven y divertida.", "En adopcion", 2, 2, 16),
